...
class OrdenDetalle(models.Model):
    ano_eje = models.CharField(primary_key=True,max_length=4)
...
class Orden(models.Model):
    ano_eje = models.CharField(primary_key=True, max_length=4)
    n_orden = models.ForeignKey(OrdenDetalle, db_column='n_orden')
...
class Requerimiento(models.Model):
    ...
    clasifica = models.CharField(max_length=1)
    # n_requer = models.IntegerField()
    n_requer = models.ForeignKey(RequerDetalle, db_column='n_requer')
    fecha = models.DateTimeField()
